...
{
    public class DangerMeterManager : MonoBehaviour
    {
        public static DangerMeterManager Instance;
        ...
        public static void Init(Transform dangerous)
        {
            ...
            if (IsVR)
            {
                ...
                if (UI != null)
                {
                    ...
                    DangerMeterManager manager = DangerMeter.AddComponent<DangerMeterManager>();
                    Instance = manager;
